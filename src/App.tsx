...
import { Play, Pause, RotateCcw, Plus, Trash2, Check, Leaf, Settings, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in-down">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <Leaf className="text-pink-400 w-10 h-10 animate-float" style={{ animationDelay: '0.5s' }} />
          </div>
          <p className="text-purple-500 text-lg animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-6 border-4 border-purple-200 animate-scale-in relative overflow-hidden">
          ...
          {showSettings && (
            <div className="mb-6 p-6 bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl border-2 border-purple-200 relative z-10 animate-slide-down">
              <h3 className="text-xl font-bold text-purple-700 mb-4">⚙️ Timer Settings</h3>
          ...
          <div className="flex justify-center gap-6 text-center relative z-10">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-2xl px-6 py-3 border-2 border-purple-200 transform hover:scale-110 transition-all duration-300 animate-float" style={{ animationDelay: '0.3s' }}>
        ...
        {/* Task Input */}
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-6 mb-6 border-4 border-pink-200 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Task List */}
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-6 border-4 border-blue-200 animate-slide-up" style={{ animationDelay: '0.3s' }}>
          <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent mb-4 flex items-center gap-2">
            <span className="animate-bounce" style={{ animationDelay: '0.2s' }}>🌳</span> Your Garden
          </h2>
          {tasks.length === 0 ? (
        ...
        <div className="text-center mt-8 text-purple-500 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <p className="text-sm animate-float">🌿 {focusTime} min focus • {breakTime} min break • Stay productive 🌿</p>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @keyframes float-particle {
          ...
          50% { opacity: 0.6; }
          100% { transform: translate(var(--tw-translate-x, 0), -100px); opacity: 0; }
        }
        @keyframes twinkle {
          0%, 100% { opacity: 0.2; }
          50% { opacity: 1; }
